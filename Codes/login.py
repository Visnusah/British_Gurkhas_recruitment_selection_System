...
def save_login():
    # use the global variables because we are going to modify them
...
# don't have account button function
def register():
    root.destroy()
    import register
...
# create a main frame
main_Frame = ctk.CTkFrame(root, width=555, height=431, corner_radius=30)
